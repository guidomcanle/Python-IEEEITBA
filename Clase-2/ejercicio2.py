...
nombreAcortado = nombre[0] + ". " + apellido
nombreYApellidoAcortado = nombre[0] + ". " + apellido[0:24]

if len(nombreYApellido) <= 26:
    print("Nombre Admitido")
else:
    if len(nombreAcortado) <= 26:
        print("Se guardó su nombre como", nombreAcortado, "por su longitud")
    else:
        print("Se guardó su nombre como", nombreYApellidoAcortado, "por su longitud")